package com.slingdelegation.core.support;
...
/**
 * Implementation of the {@link ComponentContext} that allows to pass {@link Page} and {@link ComponentContext} as constructor parameters.
 * <br>
 * Provides a solution to save a static reference to any {@link Page} in order to define the page for a request.
 */
